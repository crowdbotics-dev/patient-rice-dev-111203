"""
Django settings for patient_rice_dev_111203 project.
...
ROOT_URLCONF = 'patient_rice_dev_111203.urls'
...
WSGI_APPLICATION = 'patient_rice_dev_111203.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_rice_dev_111203 API",
    "DESCRIPTION": "API documentation for patient_rice_dev_111203 App",
    "VERSION": "v1",
}
